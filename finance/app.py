...
def buy():
    ...
    if request.method == "GET":
        ...
        if shares < 0:
            return apology ("Stocks with negative values? Seems strange.")
...
def add_cash():
    ...
    if request.method == "GET":
        ...
        if not new_cash:
            return apology("Try to type an amount of money next time")
...
def register():
    ...
    if request.method == "GET":
        ...
        """Making sure to store the hash of the users password in the db"""
...
def sell():
    ...
    if request.method == "GET":
        ...
        if shares < 0:
            return apology ("Sorry, not possible")
